    ...
    programs[1].forEach(function (val2) {
      programs[2].forEach(function (val3) {
        ...
        temp.forEach(function (t) {
          if (t.rarity === _Building__WEBPACK_IMPORTED_MODULE_31__["BuildingRarity"].Legendary) {
            legendary += 1;
          } else if (t.rarity === _Building__WEBPACK_IMPORTED_MODULE_31__["BuildingRarity"].Rare) {
            rare += 1;
          }
        ...
        temp.forEach(function (t) {
          ...
          addition.buildings.push({
            online: Math.round(a[_Buff__WEBPACK_IMPORTED_MODULE_0__["BuffRange"].Online] * 100),
            offline: Math.round(a[_Buff__WEBPACK_IMPORTED_MODULE_0__["BuffRange"].Offline] * 100),
            building: t
          });
        });
